...
class PaymentDisclosureTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        try:
            ...
            assert_equal("payment disclosure is disabled" in errorString, True)
        ...
        try:
            ...
            errorString = e.error['message']
            assert_equal("No information available about transaction" in errorString, True)
        ...
        try:
            ...
            errorString = e.error['message']
            assert_equal("Transaction has not been confirmed yet" in errorString, True)
        ...
        try:
            ...
            errorString = e.error['message']
            assert_equal("Invalid js_index" in errorString, True)
        ...
        try:
            ...
            errorString = e.error['message']
            assert_equal("Invalid output_index" in errorString, True)
        ...
        assert( result["value"] == output_value_sum )
        ...
        try:
            ...
            errorString = e.error['message']
            assert_equal("Could not find payment disclosure info for the given joinsplit output" in errorString, True)
        ...
        try:
            ...
            errorString = e.error['message']
            assert_equal("Transaction is not a shielded transaction" in errorString, True)
